...
BLOG_AUTHOR = "Ashish R Vidyarthi"
BLOG_TITLE = "Programmer's notebook"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://ashishrv.github.io/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pyfunc.blogspot.com/"
BLOG_EMAIL = "ashishdotvid@gmaildotcom"
BLOG_DESCRIPTION = "A future Reference ..."
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://www.linkedin.com/in/arvidyarthi/', 'About me', 'icon-user'),
        ('https://twitter.com/arvidyarthi', 'My Twitter', 'icon-twitter'),
        ('https://github.com/ashishrv', 'My Github', 'icon-github'),
    )
}
